...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $link = "http://localhost/udm_class_record/public/reset_password.php?token=$token";

        // Simulate sending email (in a real app, you'd send an actual email)
        $message = "Password reset link has been sent to your email address.<br>: <a href='$link'>Click here to reset your password</a>";
...
<head>
    ...
    <title>Forgot Password - Universidad De Manila</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.11.3/font/bootstrap-icons.min.css" rel="stylesheet">
    <style>
       body {
    background: url('assets/img/UDM.png') no-repeat center center fixed;
