...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $check = $conn->prepare("SELECT * FROM teachers WHERE username = ?");
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO teachers (username, password_hash, full_name, email) VALUES (?, ?, ?, ?)");
...
<head>
    ...
    <title>Teacher Registration - Universidad De Manila</title>
