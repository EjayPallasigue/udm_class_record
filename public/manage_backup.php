...
// Function to safely delete from table if it exists (copied for consistency, though not used in this specific page's primary function)
...
if (tableExists($conn, 'backup_history')) { // Assuming a 'backup_history' table exists
    ...
    if ($stmt_history) {
        ...
        $backup_history = $result_history->fetch_all(MYSQLI_ASSOC);
        $stmt_history->close();
    } else {
        error_log("Failed to prepare statement for fetching backup history: " . $conn->error);
...
<head>
    ...
    <title>Manage Backup - Universidad De Manila</title>
...
<div class="main-wrapper">
    ...
    <main class="content-area">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="file_display" class="form-label">Selected SQL file for import:</label>
                    ...
                    <div class="modal-body">
                        <ol>
                            ...
                            <li><strong>To save a backup:</strong><br>
                                Click the <strong>"Save Database"</strong> button to download a `.sql` file. This will be automatically downloaded in <code>classrecorddb</code> folder on your Google Drive.
                            </li>
                            <li><strong>To import a backup:</strong><br>
                                Click <strong>"Import Database"</strong>, choose a `.sql` file (e.g., from your <code>classrecorddb</code> folder), and confirm the warning popup.
                            </li>
    ...
    <video width="560" height="315" controls>
        <source src="assets/videos/managebackuptuts.mp4" type="video/mp4">
